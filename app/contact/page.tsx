...
export default function ContactPage() {
    ...
    return (
        <div className="relative min-h-screen bg-linear-to-r from-blue-50 via-white to-blue-100">
                        ...
                        >
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                {[
                                    ...
                                    >
                                        <div className="w-16 h-16 bg-linear-to-r from-blue-500 to-blue-700 rounded-full flex items-center justify-center mx-auto mb-4">
