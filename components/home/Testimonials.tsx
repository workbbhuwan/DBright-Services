                        ...
                        {currentTestimonials.map((t, i) => (
                            ...
                            >
                                ...
                                <div className="flex items-center gap-2 mb-6">
                                    <div className="w-7 h-7 rounded-md bg-[#135b3e] flex items-center justify-center">
                                        <span className="text-white text-xs font-bold">{t.company.charAt(0)}</span>
                                    </div>
                                    <span className="text-base font-bold text-gray-900">{t.company}</span>
                                </div>
