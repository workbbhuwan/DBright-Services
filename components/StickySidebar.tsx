  ...
  return (
    <div className="fixed right-0 top-1/2 -translate-y-1/2 z-50 flex flex-col gap-3 pr-3">
      ...
      <a
        ...
        aria-label="Call us"
        className="group flex items-center justify-center w-14 h-14 rounded-full bg-[#116f76] text-white shadow-lg hover:scale-110 hover:shadow-xl transition-all duration-300"
      >
